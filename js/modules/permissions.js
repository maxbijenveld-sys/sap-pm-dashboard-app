...
export function computeAccess({ isAdmin, rows, email }) {
  ...
  // ooit alle rijen doorgeeft. Bewust fail-closed bij een leeg e-mailadres:
  // eerder matchte `!em` per ongeluk ALLE rijen (elke gebruiker) i.p.v. geen
  // enkele — onschadelijk zolang RLS de rows al voorfiltert, maar de
  // faalrichting van deze guard hoort andersom te zijn voor rechten-logica.
